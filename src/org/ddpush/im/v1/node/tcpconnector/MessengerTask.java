...
//debug msg
		...
		{
			System.out.println("CMD_0x00");
		}else

		if(cm.getCmd() == ClientStatMachine.CMD_0x10)
		{
			System.out.println("CMD_0x10");
		}else

		if(cm.getCmd() == ClientStatMachine.CMD_0x11)
		{
			System.out.println("CMD_0x11");
		}else

		if(cm.getCmd() == ClientStatMachine.CMD_0x20)
		{
			System.out.println("CMD_0x20");
		}else

		if(cm.getCmd() == ClientStatMachine.CMD_0xff)
		{
			System.out.println("CMD_0xff");
		}
		...
		// 非心跳不会产生消息,心跳激活离线消息,每个类型最多离线一条消息,靠状态机缓存
