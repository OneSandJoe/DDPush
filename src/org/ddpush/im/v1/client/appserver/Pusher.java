...
public class Pusher {
	...
	public static void main(String[] args){
		...
		try{
			boolean result;
			pusher = new Pusher("203.195.159.127",9999, 5000);
			result = pusher.push0x20Message(StringUtil.hexStringToByteArray("9e208b1759ceaf3b4235f1fd96384df7"), "{\"aps\":{\"alert\":\"我很好的\",\"badge\":1,\"sound\":\"default\"},\"content\":\"这是一条推送消息\"}".getBytes("UTF-8"));
			//result = pusher.push0x10Message(StringUtil.hexStringToByteArray("cfcd208495d565ef66e7dff9f98764da"));
			//result = pusher.push0x11Message(StringUtil.hexStringToByteArray("cfcd208495d565ef66e7dff9f98764da"),128);
